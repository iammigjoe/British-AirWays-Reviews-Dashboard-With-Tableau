...
Project: British Airways Reviews Dashboard with Tableau
	...
	•	Skills Applied: exploratory data analysis, business insights generation, dashboard design, data storytelling.
...
Projet : Tableau de bord des avis British Airways avec Tableau
	...
	•	Compétences développées : analyse exploratoire, génération d’insights, design de dashboard, data storytelling.
